...
def parser():
    ...
    parser.add_argument('--weights_file', type=str, default=r'yolov5l.pt', help='weights file name yolov5s/m/l/x.pt')
...
if __name__ == '__main__':
    ...
    img0 = cv2.imread(r'assets\uav_1.jpg')
    img_de = decoder(model, img0)
    cv2.imshow('img', img_de)
    cv2.waitKey(0)
